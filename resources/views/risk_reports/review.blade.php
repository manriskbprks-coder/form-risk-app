<x-app-layout>
 ...
 <x-slot name="header">
    <div class="flex justify-between items-center">
        <h2 class="font-semibold text-xl text-slate-900 leading-tight tracking-tight">
            {{ __('Review Laporan Risiko') }}
        </h2>
    </div>
</x-slot>

 <div class="pt-4 pb-8 sm:pb-12">
 <div class="max-w-full w-full px-4 sm:px-6 lg:px-8 mx-auto py-4 sm:py-8 space-y-8">
 ...
 <th class="px-4 py-3 border-b text-center text-xs font-extrabold text-gray-500 uppercase tracking-wider sortable" data-sort="tgl">Tgl Lapor & Ketahui</th>
 <th class="px-4 py-3 border-b text-center text-xs font-extrabold text-gray-500 uppercase tracking-wider sortable" data-sort="pelapor">Pelapor</th>
 ...
 <td class="px-4 py-3 border-b text-sm font-bold text-gray-800 text-center align-middle " data-sort-value="{{ $report->user->name }}">{{ $report->user->name }}</td>
 ...
 <td class="px-4 py-3 border-b text-center align-middle whitespace-nowrap" data-sort-value="{{ $tl->created_at->format('YmdHis') }}">
 ...
 <td class="px-4 py-3 border-b text-sm font-bold text-gray-800 text-center align-middle " data-sort-value="{{ $tl->user->name }}">{{ $tl->user->name }}</td>
 ...
 <td class="px-4 py-3 border-b text-sm text-center align-middle ">
 @php
 $resolutionColors = [
